...
export default function EditProductScreen({ navigation, route }) {
  ...
  // #TODO: Create state variables for all form fields (name, description, price, imageUrl, stock,category, status) and initialize them with the product data.
  ...
  async function handleUpdate() {
    ...
    setSubmitting(true);
    try {
      // #TODO: Make a PUT request to /products with the form data.
